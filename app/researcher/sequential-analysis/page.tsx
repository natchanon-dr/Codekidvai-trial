...
type ArtifactChecksums = Record<string, string>;
...
export default function SequentialAnalysisPage() {
  ...
  // Classify limitations into 3 groups
  ...
  return (
    <div className="min-h-screen bg-[#FFF7ED]">
      ...
      <header className="bg-white border-b border-[#FED7AA] px-6 py-3 flex items-center justify-between">
        <div>
          <p className="font-bold text-[#0F172A] text-sm">Sequential Analysis</p>
          <p className="text-xs text-[#64748B]">Phase 4 Sequence Pipeline — Pilot Validation Only</p>
        </div>
        <Link href="/researcher/dashboard" className="text-xs text-[#F37021] hover:underline">
          &larr; Dashboard
        </Link>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-6 py-8 space-y-8">
        ...
        <SectionCard
          ...
          subtitle="Frozen pilot scope — read-only artifact view"
        >
